...
from src.schemas import (
    SubjectReadSchema, TopicReadSchema, TaskReadSchema, UserReadSchema,
    UserBriefSchema, AttachmentReadSchema, TaskSubmissionReadSchema,
)
...
class TestSubjects:
    def test_get_subject_by_id_returns_subjectread_for_existing(self):
        from src.db import get_subject_by_id
        result = _run(get_subject_by_id(11))
        assert isinstance(result, (SubjectReadSchema, type(None)))
    ...
    def test_create_and_delete_subject(self):
        from src.db import add_new_subject, get_subject_by_id, delete_subject
        ...
        assert isinstance(fetched, (SubjectReadSchema, type(None)))
        if fetched:
    ...
    def test_create_subject_returns_empty_on_db_error(self):
        from src.db import add_new_subject
    ...
    def test_update_subject(self):
        from src.db import add_new_subject, update_subject, get_subject_by_id, \
            delete_subject
        created = _run(add_new_subject(
...
class TestTopics:
    ...
    def test_create_topic_returns_empty_for_missing_subject(self):
        from src.db import add_new_topic
        result = _run(add_new_topic(
            name="__test_topic",
            description="temp",
            user_id=1,
    ...
    def test_update_topic(self):
        from src.db import add_new_topic, update_topic, delete_topic
...
class TestTasks:
    ...
    def test_create_task_text(self):
        from src.db import add_new_task, delete_task
    ...
    def test_create_task_returns_empty_for_missing_topic(self):
        from src.db import add_new_task
        result = _run(add_new_task(
            topic_id=-1,
            name="__test_task",
            description="",
    ...
    def test_update_task(self):
        from src.db import add_new_task, update_task_fields, delete_task
...
class TestUsers:
    ...
    def test_is_in_users_returns_bool(self):
        from src.db import is_in_users
        data = {
    ...
    def test_add_new_user_and_cleanup(self):
        from src.db import add_new_user, get_user_by_email, is_in_users
...
class TestStudentAttempts:
    def test_save_student_attempt_returns_bool(self):
        from src.db import save_student_attempt
...
class TestAttachments:
    def test_add_task_attachment(self):
        from src.db import add_task_attachment
